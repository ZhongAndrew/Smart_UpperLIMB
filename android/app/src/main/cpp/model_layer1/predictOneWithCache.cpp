    ...
    namespace learning
    {
      namespace coder
      {
        namespace ensembleutils
        {
          ...
          // Return Type  : bool
          //
          bool predictOneWithCache(const array<double, 2U> &X, array<double, 2U>
            &cachedScore, array<double, 1U> &cachedWeights, const char combiner
            [15], const ::coder::classreg::learning::classif::
            CompactClassificationTree &weak_learner, const array<bool, 1U>
            &useObsForLearner, array<double, 2U> &score)
          {
            array<double, 2U> b_X;
            array<double, 2U> learnerscore;
            array<double, 2U> r2;
