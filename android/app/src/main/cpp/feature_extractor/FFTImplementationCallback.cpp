                                                   ...
                                                   creal_T y[256])
{
  ...
  y[128].re = 0.5 * ((temp_re - temp_im) + (temp_re - (-b_re)));
  y[128].im = 0.5 * ((temp_re + temp_im) + (-temp_re + b_re));
  for (int i{0}; i < 63; i++) {
    temp_re = y[i + 1].re;
    temp_im = y[i + 1].im;
    j = uv[i + 1];
    ...
    y[i + 129].re = 0.5 * ((temp_re * b_im - temp_im * b_re) +
                           (temp2_re * im - -temp2_im * re));
    y[i + 129].im = 0.5 * ((temp_re * b_re + temp_im * b_im) +
    ...
    y[j + 127].re = 0.5 * ((temp2_re * b_im - temp2_im * b_re) +
                           (temp_re * im - -temp_im * re));
    y[j + 127].im = 0.5 * ((temp2_re * b_re + temp2_im * b_im) +
  ...
  b_im = y[64].re * 2.0;
  temp2_re = b_re * 0.0;
  y[64].re = 0.5 * ((re - im) + (b_im - temp2_re));
  y[64].im = 0.5 * ((re + im) + (re + b_re * 2.0));
  y[192].re = 0.5 * ((b_im - im) + (re - temp2_re));
  y[192].im = 0.5 * ((re + temp_im * 2.0) + (re + temp2_re));
}
