...
PRODUCT_NAME              = extract_features
MAKEFILE                  = extract_features_rtw.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\chen\Documents\MATLAB\codegen_output\feature_extraction
TGT_FCN_LIB               = ISO_C++11
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = extract_features_rtw_comp.rsp
CMD_FILE                  = extract_features_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = extract_features.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=extract_features
...
extract_features_initialize.obj : "$(START_DIR)\extract_features_initialize.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\extract_features_initialize.cpp"


extract_features_terminate.obj : "$(START_DIR)\extract_features_terminate.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\extract_features_terminate.cpp"


extract_features.obj : "$(START_DIR)\extract_features.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\extract_features.cpp"
...
std.obj : "$(START_DIR)\std.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\std.cpp"
