...
void bc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::bc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void cc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::cc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void dc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::dc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void ec_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::ec_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void fc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::fc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void gc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::gc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void hc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::hc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void ic_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::ic_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void jc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::jc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void kc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::kc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void lc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::lc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void mc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::mc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
...
void nc_predictOneWithCache(
    const array<double, 2U> &X, array<double, 2U> &cachedScore,
    array<double, 1U> &cachedWeights, const char combiner[15],
    const ::coder::classreg::learning::classif::nc_CompactClassificationTree
        &weak_learner,
    bool &cached, const array<bool, 1U> &useObsForLearner, bool initCache,
    array<double, 2U> &score);
