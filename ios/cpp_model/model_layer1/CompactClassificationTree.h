...
public:
  void init();
  double predict(const double Xin[270], double scores[2]) const;
  void b_init();
  void c_init();
  void d_init();
  void e_init();
...
public:
  ...
  void d_init();
  void e_init();
  double CutPredictorIndex[229];
  double Children[458];
  double CutPoint[229];
  bool NanCutPoints[229];
  bool InfCutPoints[229];
  int ClassNamesLength[2];
  coderutils::Transform ScoreTransform;
  double Prior[2];
  bool ClassLogicalIndices[2];
  double Cost[4];
  double ClassProbability[458];
};
...
public:
  ...
  double predict(const double Xin[270], double scores[2]) const;
  void b_init();
  double CutPredictorIndex[219];
  double Children[438];
  double CutPoint[219];
  bool NanCutPoints[219];
  bool InfCutPoints[219];
  int ClassNamesLength[2];
  coderutils::Transform ScoreTransform;
  double Prior[2];
  bool ClassLogicalIndices[2];
  double Cost[4];
  double ClassProbability[438];
};
...
public:
  void init();
  double predict(const double Xin[270], double scores[2]) const;
  double CutPredictorIndex[217];
  double Children[434];
  double CutPoint[217];
  bool NanCutPoints[217];
  bool InfCutPoints[217];
  int ClassNamesLength[2];
  coderutils::Transform ScoreTransform;
  double Prior[2];
  bool ClassLogicalIndices[2];
  double Cost[4];
  double ClassProbability[434];
};
...
public:
  ...
  double predict(const double Xin[270], double scores[2]) const;
  void b_init();
  double CutPredictorIndex[209];
  double Children[418];
  double CutPoint[209];
  bool NanCutPoints[209];
  bool InfCutPoints[209];
  int ClassNamesLength[2];
  coderutils::Transform ScoreTransform;
  double Prior[2];
  bool ClassLogicalIndices[2];
  double Cost[4];
  double ClassProbability[418];
};
